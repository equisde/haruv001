...
public:
    ...
    void setupUi(QWidget *MarketBrowser)
    {
        ...
        haru = new QLabel(MarketBrowser);
        haru->setObjectName(QStringLiteral("haru"));
        sizePolicy1.setHeightForWidth(haru->sizePolicy().hasHeightForWidth());
        haru->setSizePolicy(sizePolicy1);
        QFont font;
        font.setPointSize(27);
        haru->setFont(font);
        haru->setMouseTracking(true);
        haru->setText(QStringLiteral("$ 1000 USD"));
        haru->setScaledContents(false);
        haru->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(haru);
        ...
        label_3->setPixmap(QPixmap(QString::fromUtf8(":/icons/haru")));
    ...
    void retranslateUi(QWidget *MarketBrowser)
    {
        ...
        label_4->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-size:20px;font-weight:600; color:#FFFFFF;\">Haru Market Information</span></p></body></html>", 0));
        ...
        label_15->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">Current HARU Market Cap</span></p></body></html>", 0));
        label_5->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">Last HARU/BTC Price</span></p></body></html>", 0));
        label_14->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">Last HARU/USD Price</span></p></body></html>", 0));
        ...
        label_31->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">HARU Price Calculator :</span></p></body></html>", 0));
        label->setText(QApplication::translate("MarketBrowser", "HARU", 0));
