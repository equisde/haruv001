...
public:
    ...
    void retranslateUi(QWidget *ProofOfImage)
    {
        ...
        createPushButton->setText(QApplication::translate("ProofOfImage", "Create Timestamp (Pay 0.001 HARU) Proof of Data*", 0));
        label_2->setText(QApplication::translate("ProofOfImage", "<html><head/><body><p><span style=\" font-style:italic; color:#ff0000;\">*Warning:</span> This sends <span style=\" font-weight:600;\">0.001 HARU</span> to a new address generated by hashing the image or data file selected. The address can be checked on a Haru block explorer for a proof of creation date timestamp.</p></body></html>", 0));
        label->setText(QApplication::translate("ProofOfImage", "Generated Timestamp Haru Address:", 0));
        ...
        label_5->setText(QApplication::translate("ProofOfImage", "Check a previous Transaction Hash for Haru proofs.", 0));
