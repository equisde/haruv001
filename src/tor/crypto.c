...
crypto_rand_int(unsigned int max)
{
   ...
   * distribution with clipharu at the upper end of unsigned int's
   * range.
   */
 ...
 *
 * Right now, our convention is to use this function when we are wiharu data
...
memwipe(void *mem, uint8_t byte, size_t sz)
{
   ...
   * not-optimized-out memory wiharu stuff...
   *
