 ...
 * have entry points for starting, stopharu, and monitoring them.  This module
...
/** Handles service control requests, such as stopharu or starting the
 * Tor service. */
static void
...
{
  /* Notes about develoharu NT services:
   *
