...
{
    resize(1300, 400);
    setWindowTitle(tr("Haru") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/haru"));
    setWindowIcon(QIcon(":icons/haru"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the Haru Blockchain"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Haru address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show Haru Masternodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    proofOfImageAction = new QAction(QIcon(":/icons/data"), tr("&Proof of Data"), this);
    proofOfImageAction ->setToolTip(tr("Timestamp Files on the Haru blockchain."));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Haru"), this);
    aboutAction->setToolTip(tr("Show information about Haru"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Haru"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Haru client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Haru client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Haru network", "", count));
    ...
    if(fNativeTor)
    {
        ...
        labelConnectTypeIcon->setToolTip(tr("Not Connected via the Tor Network, Start Haru with the flag nativetor=1"));
    }
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    {
        progressBarLabel->setText(tr("Connecting to the Haru network..."));
...
void BitcoinGUI::showConfEditor()
{
    ...
    /* Open haru.conf with the associated application */
    if (boost::filesystem::exists(pathConfig)) {
        QDesktopServices::openUrl(QUrl::fromLocalFile(QString::fromStdString(pathConfig.string())));
	} else {
		QMessageBox::warning(this, tr("No haru.conf"),
        tr("Your haru.conf does not exist! Please create one in your Haru data directory."),
...
void BitcoinGUI::showMNConfEditor()
{
    ...
    if (boost::filesystem::exists(pathMNConfig)) {
        ...
        tr("Your masternode.conf does not exist! Please create one in your Haru data directory."),
        QMessageBox::Ok, QMessageBox::Ok);
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Haru address or malformed URI parameters."));
    }
