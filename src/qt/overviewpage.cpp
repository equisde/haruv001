...
const QString BaseURL = "http://cryptoharu.com/haruusd.php";
const QString BaseURL2 = "http://cryptoharu.com/harubtc.php";
const QString BaseURL3 = "http://cryptoharu.com/harubtc.php";
double harux;
double bzlcoinx;
double dnrbtcx;
