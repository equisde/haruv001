...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Haru version") + " 1.0.0.0 \n\n" +
                _("Usage:") + "\n" +
                  "  harud [options]                     " + "\n" +
                  "  harud [options] <command> [params]  " + _("Send command to -server or harud") + "\n" +
                  "  harud [options] help                " + _("List commands") + "\n" +
                  "  harud [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "haru:"))
                fCommandLine = true;
...
{
    string strUsage = _("*------HaruNetwork------* \nOptions:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: haru.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: harud.pid)") + "\n" +
