...
#ifndef BITCOIN_ALLOCAHARUS_H
#define BITCOIN_ALLOCAHARUS_H
 ...
 * those functions are used naively. This class simulates stacking memory locks by keeharu a counter per page.
 *
